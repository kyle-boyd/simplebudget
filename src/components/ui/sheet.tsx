...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      // Transparent overlay to avoid a dimmed scrim when the sheet is open.
      // Keep the element for Radix positioning/animations but let clicks pass through.
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps & { hideOverlay?: boolean; overlayClassName?: string }
